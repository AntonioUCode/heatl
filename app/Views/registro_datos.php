...
<head>
    ...
    <link href='../public/assets/css/addatos.css' rel='stylesheet'>
    <link href='https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.0.3/css/font-awesome.css' rel='stylesheet'>
    <script type='text/javascript' src='../public/assets/js/jquery.min.js'></script>
    <script type='text/javascript' src='../public/assets/js/addatos.js'></script>
</head>
                    ...
                    <form id="msform">
                        ...
                        <fieldset>
                            <div class="form-card">
                                ...
                                <div class="row justify-content-center">
                                    <div class="col-3"> <img src="../public/assets/image/la palomita.png" class="fit-image"> </div>
                                </div> <br><br>
                                <div class="row justify-content-center">
